<x-layouts.guest title="Acceso denegado">
    ...
    <div class="flex flex-col items-center text-center py-4">
        ...
        <svg viewBox="0 0 280 200" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-64 h-auto mb-6"
            aria-hidden="true">
            <!-- Halo de fondo -->
            ...
            <!-- Escudo -->
            <path d="M140 36 L188 56 L188 100 C188 128 166 150 140 160 C114 150 92 128 92 100 L92 56 Z" fill="white"
            ...
            <path d="M128 96 L128 88 C128 80 152 80 152 88 L152 96" stroke="oklch(46.9% 0.152 301.7)" stroke-width="4"
