<x-layouts.app :title="'Editar rol: ' . $role->name">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm opacity-70">Modifica el nombre y los permisos asignados al rol <strong>{{ $role->name }}</strong>.</p>
    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" name="permissions[]" class="checkbox checkbox-primary checkbox-sm" x-model="permissions" :value="'{{ $permission->name }}'" />
