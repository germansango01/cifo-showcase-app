<x-layouts.admin :title="__('admin.tags.title')">
    ...
    <x-admin.ui.confirm-delete id="confirm-delete-tag" :title-key="'admin.tags.delete_modal_title'">
                            ...
                            <div class="flex justify-end gap-1">
                                ...
                                @can('tags.delete')
                                    <button type="button" class="btn btn-ghost btn-xs btn-square"
                                        @click="deleteName = @js($tag->name); deleteUrl = '{{ route('tags.destroy', $tag) }}'; $nextTick(() => document.getElementById('confirm-delete-tag').showModal())">
