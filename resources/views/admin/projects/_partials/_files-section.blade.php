...
<div x-data="{
    ...
    <template x-for="(row, index) in rows" :key="index">
        <div
            class="grid grid-cols-1 md:grid-cols-[140px_1fr_1fr_1fr_auto] gap-3 items-start p-3 bg-base-200 rounded-lg mb-2">
            ...
            <div class="form-control">
                ...
                <select :name="`files[${index}][type]`" x-model="row.type"
            ...
            <div class="form-control">
                ...
                <input type="url" :name="`files[${index}][url]`" x-model="row.url" required placeholder="https://"
            ...
            <div class="form-control">
                ...
                <input type="text" :name="`files[${index}][label][es]`" x-model="row.label.es"
                    class="input input-bordered input-sm w-full" />
            </div>
            ...
            <div class="form-control">
                ...
                <input type="text" :name="`files[${index}][label][ca]`" x-model="row.label.ca"
                    class="input input-bordered input-sm w-full" />
            </div>

            {{-- remove --}}
            <div class="flex items-end pb-0.5 self-end">
                <button type="button" @click="removeRow(index)" class="btn btn-sm btn-ghost btn-error"
    ...
    <button type="button" @click="addRow({ type: 'pdf', url: '', label: { es: '', ca: '' } })"
