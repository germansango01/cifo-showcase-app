<x-layouts.app :title="'Permisos'">
    ...
    <x-admin.ui.alert type="info" class="mb-6">
        ...
        <code class="font-mono text-xs bg-base-300 px-1 py-0.5 rounded">php artisan db:seed --class=RolesAndPermissionsSeeder</code>.
    </x-admin.ui.alert>

    <div class="space-y-3">
        @foreach($permissions as $module => $modulePerms)
        <details class="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl" open>
            <summary class="collapse-title text-base font-semibold capitalize flex items-center gap-2 cursor-pointer select-none">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-base-200">
                                ...
                                <td>
                                    ...
                                    <x-admin.ui.badge type="{{ match($action) {
                                                'view'         => 'info',
                                                'create'       => 'success',
                                                'update'       => 'warning',
                                                'delete'       => 'error',
                                ...
                                <td>
                                    <div class="flex flex-wrap gap-1">
                                        ...
                                        <x-admin.ui.badge type="primary">{{ $role->name }}</x-admin.ui.badge>
                                        @empty
