...
>
    <div class="card-surface">
        ...
        <div class="card-media">
            <img class="card-image" src="{{ $project->thumbnail }}" alt="{{ __('Captura de pantalla de') }} {{ $title }}" width="600" height="400" loading="lazy">
            <button class="card-quick-view" aria-label="{{ __('Vista rápida') }}: {{ $title }}" data-open-modal="{{ $project->id }}">
                {{ __('Vista rápida') }}
            </button>
        </div>
