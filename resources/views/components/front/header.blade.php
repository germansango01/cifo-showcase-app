        ...
        <nav class="header" aria-label="{{ __('front.nav.aria_label') }}">
            <div class="header-inner">
                ...
                <a href="{{ route('home') }}" class="header-logo"
                    aria-label="{{ config('app.name') }} — {{ __('front.nav.home') }}">
                    <img src="{{ asset('img/logo-placeholder.svg') }}" alt="{{ config('app.name') }}" width="200"
                        height="48">
                </a>
                ...
                <div class="header-actions">
                    ...
                    {{-- Hamburger (mobile) --}}
                    <button class="menu-toggle" aria-label="{{ __('front.nav.open_menu') }}" aria-expanded="false"
