...
<nav class="pagination" aria-label="{{ __('Paginación') }}">
    <ul class="pagination-list">
        ...
        <li class="pagination-item">
            <a class="pagination-link" href="{{ $paginator->previousPageUrl() }}" aria-label="{{ __('Página anterior') }}">‹</a>
        </li>
        @endif
        ...
        @else
        <li class="pagination-item">
            <a class="pagination-link" href="{{ $url }}" aria-label="{{ __('Página') }} {{ $page }}">{{ $page }}</a>
        </li>
        @endif
        @endforeach
        @endif
        ...
        <li class="pagination-item">
            <a class="pagination-link" href="{{ $paginator->nextPageUrl() }}" aria-label="{{ __('Página siguiente') }}">›</a>
        </li>
        @else
        <li class="pagination-item disabled" aria-disabled="true">
            <span class="pagination-link" aria-hidden="true">›</span>
